...
import Modelos.animado3;
/**
 *
 * @author Aldemaro
 */
public class dibujartodo3 extends JComponent{
       private animado3 anima;
       
       public dibujartodo3(JComponent contenedor,JPanel j){
                 super();
                this.setBounds(0, 0,contenedor.getWidth() , contenedor.getHeight());
                contenedor.add(this);
                anima= new animado3(j);
       }
