 ...
 * @author Aldemaro
 */
public class animado3 {

    private JPanel panel = null;
    Graphics g2 = null;
    public Thread hilo1 = null;
    public int x = 0, y = 0, posx = 10, posy = 30, img3 = 3, val;
    private boolean chocapuerta = false;

    public animado3(JPanel j) {
        panel = j;
    ...
    public void paint(Graphics g) {
        ...
        if (chocapuerta) {
            ...
            ImageIcon image2 = new ImageIcon(new ImageIcon(getClass().getResource("/imagenes/botellas/" + img3 + ".png")).getImage());
