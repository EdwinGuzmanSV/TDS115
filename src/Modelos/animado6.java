 ...
 * @author Aldemaro
 */
public class animado6 {

    private JPanel panel = null;
    Graphics g2 = null;
    public Thread hilo1 = null;
    public int x = 0, y = 0, posx = 20, posy = -10, img6 = 6, val;
    private boolean chocapuerta = false;

    public animado6(JPanel j) {
        panel = j;
    ...
    public void paint(Graphics g) {
        ...
        if (chocapuerta) {
            ...
            ImageIcon image2 = new ImageIcon(new ImageIcon(getClass().getResource("/imagenes/botellas/" + img6 + ".png")).getImage());
            g.drawImage(image2.getImage(), posx, posy, 90, 500, null);
        }
    }
